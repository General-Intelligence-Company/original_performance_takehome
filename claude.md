...
3. **Check recent commits** for the file you're modifying: `git log --oneline -10 -- claude.md`
...
6. **Use descriptive, unique branch names** to avoid conflicts with concurrent work (e.g., `docs/add-X-guidelines-1737543000`)
